...
매 초마다 갱신하고 싶다면 화면에서 d를 누르고 1을 입력하거나 top명령어를 실행할 때 top -d 1처럼 옵션을 입력하여 실행해도 된다.
...
## 권한
**ls -l**을 이용하여 디렉토리 정보를 출력하면 맨 앞쪽에 **drwxrwxrwx**처럼 권한에 대한 내용이 출력된다.
